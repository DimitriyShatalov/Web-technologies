...
const cels = Number.parseFloat(prompt('Введите значение температуры по Цельсию:'));
const fahr = ((9/5) * cels + 32).toFixed(2)

alert(`Значение температуры ${cels} град. по Цельсию соответствует ${fahr} град. по Фаренгейту`)

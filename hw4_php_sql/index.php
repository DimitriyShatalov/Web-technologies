...
$jobs = [
  [
    ...
    "dateStart" => "Апрель 2010",
    "dateEnd" => "Настоящее время",
    "description" => "Разработка и внедрение маркетинговой стратегии.",
  ],
  [
    "name" => "Менеджер проектов",
    "dateStart" => "Апрель 2006",
    "dateEnd" => "Апрель 2010",
    "description" => "Улучшение бизнес процессов по программе Lean Production.",
  ],
  [
    "name" => "Инженер процессов",
    "dateStart" => "Май 2004",
    "dateEnd" => "Апрель 2006",
    "description" => "Стандартизация производственных процессов.",
  ],
];
?>
<!DOCTYPE html>
